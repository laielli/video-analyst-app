...
For systematic measurement across the question bank (tiered scoring, capture/replay, CI gate),
see `api/eval/` (the eval harness) — the N-question layer; this probe stays the fast one-question
human gut-check.
"""
