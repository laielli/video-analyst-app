...
For systematic measurement across the question bank (phrasing variants, out-of-scope/injection
cases, tiered scoring, a diffable report, and a CI regression gate), see `api/eval/` — the codegen
eval harness. This probe stays the fast one-question human gut-check.
"""
