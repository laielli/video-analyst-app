...
- bank_version: `3`
- prompt_version: `93fdf5a17312c3f9`
...
- prompt size (chars): bernabeu-counter=6913, single-goal=6883
...
| `adv-injection-scene-fps-override` | MISSING | no fixture (run capture) | MISSING |
